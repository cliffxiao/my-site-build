...
?>
<div class="mess_list"> 
		 <div class="mess_title"><?php echo UserField::getUserDefineLabel($fieldinfo); ?></div>
           <div class="mess_input"> <?php echo UserField::getUserCustomComponent($fieldinfo,array(),$userparams);?>
            </div>
     </div>
<?php }?> 
	<div class="blankbar1"></div>
