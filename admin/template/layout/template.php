...
?>
	...
	echo "<div style='font-size:12px;margin-left:30px;margin-top:30px;'>".__("Buy license please!")."<a href='http://www1.sitestar.cn/license/' target='_blank'>".__("Buy herf")."</a></div>";
